...
router.post('/credential-definition', AgentBasicController.createCredentialDefinition);
router.get('/credential-definitions', AgentBasicController.getCredentialDefinition);
